...
export default function CitizenHeader({ userEmail, onLogout }: CitizenHeaderProps) {
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 shadow-lg border-b border-emerald-700/30">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-emerald-100 font-medium">Citizen Reporter</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="flex flex-col items-end">
              ...
              <span className="text-emerald-100 text-xs">Active</span>
            </div>
            <button 
              onClick={onLogout}
