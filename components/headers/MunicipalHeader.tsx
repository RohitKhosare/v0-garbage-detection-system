        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-md">
              <BarChart3 className="w-6 h-6 text-blue-mid" />
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white tracking-tight">CleanCity AI</h1>
              <p className="text-sm text-blue-sky font-medium">Municipal Coordinator</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="flex flex-col items-end">
              ...
              <span className="text-blue-sky text-xs">Administrator</span>
            </div>
            <button 
              onClick={onLogout}
